...
class BaseArgs:
    ...
    critic_seq_len: int = 4
    actor_seq_len: int = 2
    """the number of SEMs."""
    critic_norm_beta: float = 1.
    actor_norm_beta: float = 1.
    """L1/L2 norm beta regularization parameters."""
    wandb_tags: str = ""
    """the tag of wandb"""
...
def get_args():
    ...
    env_to_args_class = {
        ...
        "h1hand-stair-v0": H1HandStairArgs,
...
@dataclass
class H1HandStairArgs(HumanoidBenchArgs):
    env_name: str = "h1hand-stair-v0"
    total_timesteps: int = 156250
